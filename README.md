...
## NO ACTIVE DEVELOPMENT TAKING PLACE
This project was an early experiment in trying to achieve some of the goals stated below. Most of them were achieved. There are some useful learnings and code here, which we will likely reuse in a future project, but for now, the project is on indefinite ice.
